# Cost information {#sec-cost-info}

In this section we define our approach to estimate the average access cost for each hexagon.
We begin by describing the information layers used to define transport methods.
...
Trails are used by ATVs to access remote areas, but their distribution overlaps with roads.
...
We then rasterized the road and trail buffer polygons to a 30-meter resolution raster to calualte the minimum cost of access for each pixel across the study area.
