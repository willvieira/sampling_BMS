...
#| tbl-cap: Distribution of total hexagons, hexagons with at least 20% of natural habitats, and sample size across the ecoregions.
...
hexas |>
    ...
    select(Code, Name, `Total Hexagons`, `Available Hexagons`, `Sample size`) |>
    kbl(format = 'markdown', align = 'c')
```
...
The distribution of SSUs within an hexagon is shown in Figure1.
...
#| label: fig-PSUSSU
#| fig-cap: "Distribution of Seconday Sampling Units (SSUs) within an Primary Sampling Unit (PSU) hexagon."
