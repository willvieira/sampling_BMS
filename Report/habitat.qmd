...
For a visual example, we show the relative proportion of habitat from a sample of 10 hexagons with and without inclusion probability @fig-sample_habitat.
...
hex102 = read_sf(file.path('..', 'output', 'anticosti_island_102', 'hexa_102.shp'))
