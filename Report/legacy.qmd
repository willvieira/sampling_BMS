...
Given the high cost of sampling in remote regions and the limited resources available to sample, it is essential to take legacy and iconic sites into account in order to make the most efficient use of limited resources to extend spatial coverage to under-sampled areas.
...
In fact, their approach naturally ensures random historical sites, as they use only legacy sites while excluding iconic ones.
...
*Figure with all legacy and iconic sites*
