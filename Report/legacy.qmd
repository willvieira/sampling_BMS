...
In this report, we will refer to both iconic and legacy sites as historic sites.
...
By using the spatially balanced design while omitting historical sites, the selected hexagons are evenly distributed throughout the ecoregion, some of which overlap with the historic sites (@fig-sampleSize-example1).
